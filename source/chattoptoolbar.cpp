...
void CChatTopToolbar::InitCtrl()
{
    ...
    IconHelper::SetIcon(m_labState, QChar(0xe62d), 20);
    m_labState->setStyleSheet("color:#5FB8F1;");

    IconHelper::SetIcon(m_labEmail, QChar(0xe657), 20);
    m_labEmail->setStyleSheet("color:#ACACAC;");

    IconHelper::SetIcon(m_labPart, QChar(0xe625), 20);
    m_labPart->setStyleSheet("color:#ACACAC;");

    IconHelper::SetIcon(m_btnAddUser, QChar(0xe62c), 24);
